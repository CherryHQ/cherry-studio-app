...
export const Input = forwardRef<TextInput, InputProps>(function Input(
  ...
  const inputClassName = cn(
    multiline
      ? 'min-h-8 rounded-md border border-border text-(length:--text-base) shadow-none ios:shadow-none ios:focus:outline-transparent android:border-border android:shadow-none android:focus:border-border'

...
export const iconRegistry = {
  ...
  BrainIcon: { sf: 'brain.head.profile', material: 'psychology' },
  ...
  PaintbrushIcon: { sf: 'paintbrush', material: 'brush' },
  ...
  RadioIcon: { sf: 'dot.radiowaves.up.forward', material: 'radio' },
  ...
  TriangleAlertIcon: { sf: 'exclamationmark.triangle', material: 'warning' },

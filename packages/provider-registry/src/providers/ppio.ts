  ...
  overrides: [
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 0.25 },
        output: { currency: 'CNY', perMillionTokens: 1 },
      },
    },
    {
      ...
      pricing: {
        ...
        output: { currency: 'CNY', perMillionTokens: 0 },
      },
    },
    {
      ...
      modelId: 'deepseek-r1',
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 4 },
        output: { currency: 'CNY', perMillionTokens: 16 },
      },
    },
    {
      ...
      modelVariants: ['70b'],
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 5.8 },
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 4 },
        output: { currency: 'CNY', perMillionTokens: 12 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 2 },
        output: { currency: 'CNY', perMillionTokens: 3 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        ...
        output: { currency: 'CNY', perMillionTokens: 9 },
      },
    },
    {
    ...
    },
    {
      ...
      modelId: 'glm-4-5-air',
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 1.2 },
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 2 },
        output: { currency: 'CNY', perMillionTokens: 6 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 0.5 },
        output: { currency: 'CNY', perMillionTokens: 3 },
      },
    },
    {
      ...
      pricing: {
        ...
        output: { currency: 'CNY', perMillionTokens: 22 },
      },
    },
    {
      modelId: 'glm-image',
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 4 },
        output: { currency: 'CNY', perMillionTokens: 21 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 0.7 },
        output: { currency: 'CNY', perMillionTokens: 2.1 },
      },
    },
    {
      ...
      modelId: 'minimax-m2',
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 2.1 },
        output: { currency: 'CNY', perMillionTokens: 8.4 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 4.2 },
        output: { currency: 'CNY', perMillionTokens: 4.2 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 2 },
        output: { currency: 'CNY', perMillionTokens: 20 },
      },
    },
    {
    ...
    { apiModelId: 'qwen/qwen3.5-35b-a3b', modelId: 'qwen3-5-35b-a3b', modelVariants: ['35b'] },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 3 },
        output: { currency: 'CNY', perMillionTokens: 18 },
      },
    },
    {
    ...
    },
    {
      ...
      modelVariants: ['30b'],
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 2.25 },
        output: { currency: 'CNY', perMillionTokens: 9 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        ...
        output: { currency: 'CNY', perMillionTokens: 10 },
      },
    },
    {
    ...
    },
    {
      ...
      pricing: {
        input: { currency: 'CNY', perMillionTokens: 2 },
        output: { currency: 'CNY', perMillionTokens: 8 },
      },
    },
    {

...
| [Chat Input Interaction](./references/chat/input-interaction.md) | Target operation matrix for stable composer layout, keyboard ownership, tools, attachments, sending, and navigation (partially implemented; native acceptance pending) |

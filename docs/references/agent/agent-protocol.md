...
record does not reverse them; the Agent simply no longer sees that it made them. Regenerating or
retrying a question remains a fork (see [Branching](#branching)).

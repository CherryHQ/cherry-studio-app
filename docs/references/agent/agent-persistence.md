...
Status: **schema, durable store, Agent CRUD, Session reads, managed attachment references, and
frontend integration active in production**. Version 1 is local-only.

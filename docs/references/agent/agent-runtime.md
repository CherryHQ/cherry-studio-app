...
checkpoint contract active behind the Mobile Agent Host**; application tool configuration, Pi
compaction, and text attachment resolution remain follow-up work. Version 1 is local-only.

...
Status: **Pi Runtime, settled tool contracts, bounded managed image input, and Pi context
compaction active behind the Mobile Agent Host**; application tool configuration and text
attachment resolution remain follow-up work. Version 1 is local-only.

 ...
 * documents — in one grid, filterable by kind and visibly marked by origin.
 * The root Stack pushes it above chat, so its leading action returns to the chat surface.
 */

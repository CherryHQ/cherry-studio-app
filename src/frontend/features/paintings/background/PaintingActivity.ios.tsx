...
function PaintingActivity(props: PaintingActivityProps, environment: LiveActivityEnvironment) {
  'widget';
...
export default createLiveActivity<PaintingActivityProps>('PaintingActivity', PaintingActivity);

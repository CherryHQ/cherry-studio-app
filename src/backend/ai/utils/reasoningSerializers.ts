...
function resolveSelection(
  ...
  const declared = selectable.filter(
    (effort): effort is Exclude<ReasoningEffort, 'none' | 'auto'> =>
...
export function resolveReasoningInvocation(
  input: ResolveReasoningInvocationInput,
...
export function encodeReasoningInvocation(

...
import { McpApplication, type McpApplicationDependencies } from '../McpApplication';
...
function createSubject() {
  ...
  const dependencies: McpApplicationDependencies = {
    runtime: {
  ...
  const backend: McpBackend = new McpApplication(dependencies);

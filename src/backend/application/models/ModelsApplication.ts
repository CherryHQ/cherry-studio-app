...
const logger = loggerService.withContext('ModelsApplication');
...
export type ModelsApplicationDependencies = {
  ai: ModelsAi;
...
export class ModelsApplication implements ModelsBackend {
  constructor(private readonly dependencies: ModelsApplicationDependencies) {}

...
import {
  PaintingsApplication,
  type PaintingsApplicationDependencies,
} from '../PaintingsApplication';
...
function createSubject() {
  ...
  const dependencies: PaintingsApplicationDependencies = {
    ai: {
  ...
  const backend: PaintingsBackend = new PaintingsApplication(dependencies);

...
export type PaintingsApplicationDependencies = {
  ai: PaintingAi;
  files: FilesBackend;
...
export class PaintingsApplication implements PaintingsBackend {
  constructor(private readonly dependencies: PaintingsApplicationDependencies) {}

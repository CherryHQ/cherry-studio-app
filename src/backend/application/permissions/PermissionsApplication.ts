...
export type PermissionsApplicationDependencies = {
  device: PermissionDevice;
  preferences: PermissionPreferences;
};

export class PermissionsApplication implements PermissionsBackend {
  constructor(private readonly dependencies: PermissionsApplicationDependencies) {}

...
import {
  ...
  type PermissionsApplicationDependencies,
} from '../PermissionsApplication';

function createSubject() {
  const dependencies: PermissionsApplicationDependencies = {
    device: {
  ...
  const backend: PermissionsBackend = new PermissionsApplication(dependencies);

...
export const networkRules: readonly ScanRule[] = [
  {
    ...
    anchors: [
      /ERR_CONNECTION_(?:REFUSED|CLOSED|RESET|TIMED_OUT)|ECONNREFUSED|ECONNRESET|socket hang up/i,
    ],
  },
  {
    ...
    attribution: 'user-fixable',
    devMessage:
      'The machine appears offline or DNS resolution failed; check network connectivity and proxy settings.',
  ...
  },
  {
    ...
    anchors: [
      /ERR_CERT_[A-Z_]+|SSL_ERROR_[A-Z_]+|self.?signed certificate|unable to verify the first certificate/i,
    ],
  },
  {
    ...
    devMessage:
      'A network request timed out or failed without a specific cause; usually transient or proxy-related.',
    anchors: [

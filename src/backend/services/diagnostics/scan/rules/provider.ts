...
export const providerRules: readonly ScanRule[] = [
  ...
  },
  {
    ...
    attribution: 'user-fixable',
    devMessage:
      'A provider rejected the request over billing (402): the account is out of balance, quota, or credits.',
    anchors: [
  ...
  },
  {
    ...
    devMessage:
      'A provider throttled the request (429); retrying after a delay or rotating keys usually resolves it.',

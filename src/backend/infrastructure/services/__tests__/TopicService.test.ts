...
import type { PinService } from '@/backend/infrastructure/services/PinService';
import type { TagService } from '@/backend/infrastructure/services/TagService';
import type { Topic } from '@/shared/data/types/topic';
import { TopicService } from '../TopicService';

jest.mock('@/backend/infrastructure/db/schemas', () => ({
  messageTable: {
    topicId: 'topicId',
  },
  pinTable: {},

...
import { createRootMessageTx } from '@/backend/infrastructure/services/MessageService';
import { insertWithOrderKey } from '@/backend/infrastructure/services/utils/orderKey';
...
jest.mock('@/backend/infrastructure/services/MessageService', () => ({
  createRootMessageTx: jest.fn(),
}));
jest.mock('@/backend/infrastructure/services/utils/orderKey', () => ({

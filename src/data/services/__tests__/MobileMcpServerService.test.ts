...
describe('MobileMcpServerService integration', () => {
  let sqlite: DatabaseSync;
  let service: MobileMcpServerService;
  ...
  beforeEach(() => {
    ...
    service = new MobileMcpServerService(dbService, new McpServerService(dbService));
  });

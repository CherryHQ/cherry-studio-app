...
const defaultClaudeCodeSystem: TextBlockParam[] = [
  {
    type: 'text',
 ...
 * ```
 */
export function buildClaudeCodeSystemMessage(system?: string | TextBlockParam[]): TextBlockParam[] {
  if (!system) {
...
export function buildClaudeCodeSystemModelMessage(system?: string | TextBlockParam[]): ModelMessage[] {

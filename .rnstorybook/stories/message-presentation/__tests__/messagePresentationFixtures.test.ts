...
import { messagePresentationExamples, STORY_FILE_ENTRY_ID } from '../messagePresentationFixtures';

describe('message presentation Storybook fixtures', () => {
  it('covers every message adapter family in the playground', () => {
    const messages = messagePresentationExamples.map((example) => example.message);

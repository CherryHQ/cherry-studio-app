...
export type MessagePresentationExample = {
  label: string;
...
export const messagePresentationExamples: readonly MessagePresentationExample[] = [
  {
    label: 'User message',
    ...
    message: createMessage(
      ...
      [
        ...
        },
        {
          ...
          state: 'done',
          text: 'The presentation boundary can stay independent from virtualization.',
          type: 'reasoning',
        },
      ],
      'pending',
...
function createMessage(
  ...
  status: MessagePresentationItem['status'] = 'success',
